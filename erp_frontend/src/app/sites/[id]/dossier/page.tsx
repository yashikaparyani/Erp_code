                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex gap-2 mt-0.5 flex-wrap">
                        ...
                        {doc.linked_project && (
                          <span className="text-[10px] text-blue-500">{doc.linked_project}</span>
                        )}
...
export default function SiteDossierPage() {
  ...
  const [dossier, setDossier] = useState<SiteDossierData | null>(null);
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 text-xs text-slate-500 mb-1">
            ...
            <span>/</span>
            <span className="text-slate-800 font-medium">Site Dossier</span>
          </div>
      ...
      {sortedStages.length === 0 ? (
        <div className="rounded-xl border border-slate-200 bg-white p-12 text-center">
          ...
          <p className="mt-3 text-sm text-slate-500">No documents uploaded for this site yet</p>
        </div>
      ) : (
