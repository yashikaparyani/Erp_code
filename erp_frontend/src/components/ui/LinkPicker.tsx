...
export type LookupEntity = 'project' | 'site' | 'item' | 'customer' | 'warehouse' | 'vendor' | 'invoice' | 'estimate' | 'commercial_reference' | 'purchase_order' | 'tender' | 'employee' | 'ip_pool' | 'device' | 'ticket' | 'sla_profile';
