  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Project Structure', href: '/execution/project-structure', icon: FolderTree },
      {
        ...
        icon: Cpu,
        children: [
          { name: 'Checklists', href: '/execution/commissioning/checklists', icon: ClipboardCheck },
          { name: 'Devices & IP', href: '/execution/commissioning/devices', icon: Cpu },
          { name: 'IP Pools', href: '/execution/commissioning/ip-pools', icon: Globe },
          { name: 'IP Allocations', href: '/execution/commissioning/ip-allocations', icon: Globe },
          { name: 'Test Reports & Signoffs', href: '/execution/commissioning/test-reports', icon: CheckCircle2 },
          { name: 'Client Signoffs', href: '/execution/commissioning/client-signoffs', icon: CheckCircle2 },
        ],
      },
