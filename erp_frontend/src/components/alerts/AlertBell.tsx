...
const EVENT_LABELS: Record<string, string> = {
  ...
  site_installation_stage_changed: 'Installation Stage Changed',
  ...
  indent_submitted: 'Indent Submitted',
  indent_acknowledged: 'Indent Acknowledged',
  indent_accepted: 'Indent Accepted',
  indent_rejected: 'Indent Rejected',
  indent_returned: 'Indent Returned',
  indent_escalated: 'Indent Escalated',
