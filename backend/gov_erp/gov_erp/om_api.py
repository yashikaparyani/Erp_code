...
def get_rma_trackers(project=None, status=None, ticket=None):
	...
	data = frappe.get_all(
		...
		fields=[
			...
			"item_description", "item_make", "item_model",
			"asset_serial_number", "qty", "faulty_date",
			"source_location_name", "received_from_field_date", "inbound_dc_challan_no",
			"problem_description", "dispatch_destination",
			"service_partner_name", "warranty_status", "repairability_status",
			"rma_reference_no", "approval_status", "rma_purchase_order_no",
			"repairing_status", "return_received_dc_challan_no",
			"return_dispatch_location_name", "aging_days", "rma_status", "rework_required",
