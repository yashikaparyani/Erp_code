...
def get_bid(name):
    ...
    bid_dict["tender_detail"] = {
        ...
        "creation": tender_doc.get("creation"),
        "owner": tender_doc.get("owner"),
        "client": tender_doc.get("client"),
        "organization": tender_doc.get("organization"),
        "tender_document": tender_doc.get("tender_document"),
        "rfp_document": tender_doc.get("rfp_document"),
        ...
        "go_no_go_status": tender_doc.get("go_no_go_status"),
        "go_no_go_by": tender_doc.get("go_no_go_by"),
        "go_no_go_on": tender_doc.get("go_no_go_on"),
        "technical_readiness": tender_doc.get("technical_readiness"),
        "commercial_readiness": tender_doc.get("commercial_readiness"),
