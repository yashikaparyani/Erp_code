...
class PermissionEngine:
    ...
    def get_visible_tabs(self, project_name=None):
        ...
        tab_caps = {
            ...
            "ops":           ["project.workspace.access"],
            "issues":        ["project.workspace.access"],
            "staff":         ["project.member.manage", "project.workspace.access"],
            "petty_cash":    ["project.workspace.access"],
            "comms":         ["project.workspace.access"],
            "central_status": ["project.workspace.access"],
            "requests":      ["project.workspace.access"],
            "notes":         ["project.workspace.access"],
            "tasks":         ["project.workspace.access"],
            "timesheets":    ["project.workspace.access"],
            "files":         ["dms.file.view", "engineering.file.view",
                             "procurement.file.view", "execution.file.view"],
            "activity":      ["project.activity.view"],
            "dossier":       ["dms.file.view", "project.workspace.access"],
            "accountability": ["reports.module.access"],
            "approvals":     ["approval.inbox.access", "approval.action.approve",
                              "approval.action.reject", "approval.action.override"],
            "closeout":      ["project.workspace.access"],
        }
        visible = []
